...
class OSCARSSR
{
  ...
  public:
    ...
    TVector3D GetB  (double const X, double const Y, double const Z, double const T = 0) const;
    TVector3D GetB  (TVector3D const& X, double const T = 0) const;

    TVector3D GetE  (double const X, double const Y, double const Z, double const T = 0) const;
    TVector3D GetE  (TVector3D const& X, double const T = 0) const;
