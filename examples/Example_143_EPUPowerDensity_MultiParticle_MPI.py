...
if rank == 0:
    ...
    plot_power_density(pd_multi, ofile='EPUPowerDensity_Ideal.png', show=False)
    ...
    plot_power_density(osr_sum.get_power_density(), ofile='EPUPowerDensity_MultiParticle.png', show=False)
