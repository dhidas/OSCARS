...
# Import the OSCARS SR and helpful modules
import oscars.sr
...
# we assume OSG is handling this
osr.set_nthreads_global(1)

# Set a paricle beam with non-zero emittance
...
# Clear any existing fields (just good habit in notebook style) and add
# an undulator field
osr.clear_bfields()
