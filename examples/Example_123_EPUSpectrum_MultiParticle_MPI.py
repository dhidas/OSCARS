...
#   mpiexec -n 5 python Example_123_EPUSpectrum_MultiParticle_MPI.py
...
if rank == 0:
    ...
    plot_spectra([spectrum_se, osr_sum.get_spectrum()], ['single-electron', 'multi-electron'], ofile='EPUSpectrum_MPI.png', show=False)
