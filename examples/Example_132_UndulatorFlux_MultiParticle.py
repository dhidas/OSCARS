...
spectrum_me = osr.calculate_spectrum(obs=[0, 0, 30], energy_range_eV=[130, 160], npoints=500, nparticles=100, nthreads=8)
plot_spectra([spectrum_se, spectrum_me], ['single-electron', 'multi-electron'])

# Calcuate flux at 30 [m] for 152 eV
flux_multi = osr.calculate_flux_rectangle(plane='XY',
                                          energy_eV=152,
                                          width=[0.01, 0.01],
                                          npoints=[51, 51],
                                          translation=[0, 0, 30],
